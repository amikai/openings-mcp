...
func TestJob104GetJobDetailE2E(t *testing.T) {
	...
	want := &job104DetailOutput{
		...
		Skill:          []string{"軟體程式設計", "軟體工程系統開發", "AI"},
		Certificate:    []string{"丙級會計事務技術士"},
		DriverLicense:  []string{"普通重型機車", "普通小型車"},
		Language:       []string{"英文 — 聽:中等、說:略懂、讀:中等、寫:略懂"},
		LocalLanguage:  []string{"台語 — 精通"},
		Other:          "高度邏輯思考能力、善於溝通系統需求與設計取捨、具備獨立軟體開發能力\n具 Azure DevOps、Docker、Kubernetes 經驗者優先\n\n- 熟悉現代軟體系統研發流程與版本控制\n- 熟悉至少一種指令式程式設計語言（C#、JavaScript、Python、PHP 尤佳）\n- 具 ASP.NET、SQL、Vue.js、Laravel、Unity、GIS、IoT、Revit等開發經驗\n- 具軟體設計、開發、運營、開發、機器學習、AI 模型訓練 (Finetuning)、 AI 應用設計（OCR、RAG、LLM、Agentic 等）開發、導入經驗\n",
		AcceptRole:     []string{"原住民"},
		ManageResp:     "不需負擔管理責任",
		NeedEmp:        "2~3人",
...
func TestJob104HTTPToMCPDetail(t *testing.T) {
	in := job104.JobDetailResponse{
		Data: job104.JobDetail{
			...
			Condition: job104.JobDetailCondition{
				...
				Skill: []job104.CodeDescription{
					{Code: job104.NewOptNilString("k1"), Description: job104.NewOptNilString("skill1")},
				},
				Certificate: []job104.JobDetailConditionCertificateItem{
					{Code: job104.NewOptNilInt(1), Name: job104.NewOptNilString("cert1")},
				},
				DriverLicense: []string{"dl1"},
				Language: []job104.JobDetailConditionLanguageItem{
					{
						Code:     job104.NewOptNilInt(1),
						Language: job104.NewOptNilString("英文"),
						Ability: job104.NewOptJobDetailConditionLanguageItemAbility(job104.JobDetailConditionLanguageItemAbility{
							Listening: job104.NewOptNilString("中等"),
							Speaking:  job104.NewOptNilString("略懂"),
							Reading:   job104.NewOptNilString("中等"),
							Writing:   job104.NewOptNilString("略懂"),
						}),
					},
				},
				LocalLanguage: []job104.JobDetailConditionLocalLanguageItem{
					{Code: job104.NewOptNilInt(1), Language: job104.NewOptNilString("台語"), Ability: job104.NewOptNilString("精通")},
				},
				Other: job104.NewOptNilString("other1"),
				AcceptRole: job104.NewOptJobDetailConditionAcceptRole(job104.JobDetailConditionAcceptRole{
					Role: []job104.JobDetailConditionAcceptRoleRoleItem{
						{Code: job104.NewOptNilInt(64), Description: job104.NewOptNilString("原住民")},
					},
					DisRole: job104.NewOptJobDetailConditionAcceptRoleDisRole(job104.JobDetailConditionAcceptRoleDisRole{
						NeedHandicapCompendium: job104.NewOptNilBool(true),
					}),
				}),
			},
	...
	want := &job104DetailOutput{
		...
		Specialty:              []string{"d1"},
		Skill:                  []string{"skill1"},
		Certificate:            []string{"cert1"},
		DriverLicense:          []string{"dl1"},
		Language:               []string{"英文 — 聽:中等、說:略懂、讀:中等、寫:略懂"},
		LocalLanguage:          []string{"台語 — 精通"},
		Other:                  "other1",
		AcceptRole:             []string{"原住民"},
		NeedHandicapCompendium: true,
		ManageResp:             "mr",
		NeedEmp:                "ne",
		Welfare:                "w",
		Industry:               "ind",
