...
func NewMockServer() *httptest.Server {
	...
	mux.HandleFunc("/errorpage/", serveMockHTML(_mockJobDetailNotFoundRsp))
	mux.HandleFunc("/job/1414343333/1414343333/", serveMockHTML(_mockJobDetailRsp))
	mux.HandleFunc("/search/", func(w http.ResponseWriter, r *http.Request) {
		q := r.URL.Query()
		switch {
		case q.Get("q") == "zzzznonexistentkeyword12345":
			serveMockHTML(_mockSearchNoResultsRsp)(w, r)
		case q.Get("optionsFacetsDD_department") != "" || q.Get("optionsFacetsDD_country") != "":
			serveMockHTML(_mockSearchFilteredRsp)(w, r)
		default:
			serveMockHTML(_mockSearchRsp)(w, r)
		}
	})
	mux.HandleFunc("/services/jobs/options/facetValues/", func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.Write(_mockFacetValuesRsp)
	})
