...
// "jobs.sap.com") — unlike Greenhouse or Lever, there is no shared host
// across tenants (see openapi.yaml). Every curated entry was verified
// against /search/: HTTP 200 and at least one tr.data-row result.
type Company struct {
