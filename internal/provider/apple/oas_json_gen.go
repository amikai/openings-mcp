...
var jsonFieldsNameOfSearchFilters = [6]string{
	0: "locations",
	1: "homeOffice",
	2: "keywords",
	3: "languages",
...
func (s *SearchFilters) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "homeOffice":
			if err := func() error {
				s.HomeOffice.Reset()
				if err := s.HomeOffice.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
		...
		case "teams":
			if err := func() error {
				s.Teams = make([]SearchTeamFilter, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SearchTeamFilter
					if err := elem.Decode(d); err != nil {
						return err
					}
...
// encodeFields encodes fields.
func (s *SearchTeamFilter) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("team")
		e.Str(s.Team)
	}
	{
		e.FieldStart("subTeam")
		e.Str(s.SubTeam)
	}
}

var jsonFieldsNameOfSearchTeamFilter = [2]string{
	0: "team",
	1: "subTeam",
}
...
func (s *SearchTeamFilter) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SearchTeamFilter to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "subTeam":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"subTeam\"")
			}
		default:
			return errors.Errorf("unexpected field %q", k)
		}
		...
		return errors.Wrap(err, "decode SearchTeamFilter")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSearchTeamFilter) {
					name = jsonFieldsNameOfSearchTeamFilter[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *SubTeam) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("code")
		e.Str(s.Code)
	}
	{
		e.FieldStart("teamCode")
		e.Str(s.TeamCode)
	}
	{
...
var jsonFieldsNameOfSubTeam = [3]string{
	0: "code",
	1: "teamCode",
	2: "displayName",
}
...
func (s *SubTeam) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SubTeam to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "teamCode":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"teamCode\"")
			}
		case "displayName":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
		...
		return errors.Wrap(err, "decode SubTeam")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSubTeam) {
					name = jsonFieldsNameOfSubTeam[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *TeamGroup) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		e.Str(s.ID)
	}
...
var jsonFieldsNameOfTeamGroup = [3]string{
	0: "id",
	1: "type",
	2: "teams",
}
...
func (s *TeamGroup) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TeamGroup to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode TeamGroup")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfTeamGroup) {
					name = jsonFieldsNameOfTeamGroup[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *TeamsResponse) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("res")
		e.ArrStart()
		for _, elem := range s.Res {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
...
var jsonFieldsNameOfTeamsResponse = [1]string{
	0: "res",
}
...
func (s *TeamsResponse) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TeamsResponse to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "res":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				s.Res = make([]TeamGroup, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem TeamGroup
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Res = append(s.Res, elem)
					return nil
				}); err != nil {
					return err
				}
		...
		return errors.Wrap(err, "decode TeamsResponse")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfTeamsResponse) {
					name = jsonFieldsNameOfTeamsResponse[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
