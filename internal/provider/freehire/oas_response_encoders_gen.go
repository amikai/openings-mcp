...
func encodeAgentSearchJobsResponse(response *JobListEnvelope, w http.ResponseWriter, span trace.Span) error {
...
func encodeGetCompanyResponse(response *GetCompanyOK, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
...
func encodeGetJobResponse(response *GetJobOK, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
...
func encodeGetJobFacetsResponse(response *FacetsEnvelope, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
